...
export const BANK_ACCOUNT = [
  ...
  {
    value: 'MSB',
    label: 'Ngân hàng TMCP Hàng Hải Việt Nam (MSB)',
  },
  {
    value: 'NCB',
  ...
  {
    value: 'VIETBANK',
    label: 'Ngân hàng TMCP Việt Nam Thương Tín (VietBank)',
  },
  {
    value: 'VIETABANK',
    label: 'Ngân hàng TMCP Việt Á (VietABank)',
  },
  {
